    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Cᴏɴᴛᴀᴄᴛ Dᴇᴠᴇʟᴏᴘᴇʀ [Bʏɴғ ♔ ☺️ #ꜱᴍɪʟᴇʏ | 🇮🇳 |](https://t.me/chat_with_technical_tamilan) ʜᴇ Wɪʟʟ Hᴇʟᴘ Yᴏᴜ**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍʏ ʙᴏss** [Bʏɴғ ♔ ☺️ #ꜱᴍɪʟᴇʏ | 🇮🇳 |](https://t.me/chat_with_technical_tamilan)",
